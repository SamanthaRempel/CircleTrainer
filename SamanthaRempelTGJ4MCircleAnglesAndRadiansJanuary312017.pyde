...
def draw():
    ...
    textSize(30)
    text("by Samantha Rempel", 410, 500)
    textSize(50)
    text("Circle Trainer", 400, 50)
    ...
    if mouseY != 250 and mouseX != 200 :
        ...
        if len(str(newAngle)) == 1: 
            text(str(newAngle) + '°', 540, 200) #Prints the snapped to angle value
        elif len(str(newAngle)) == 2:
            text(str(newAngle) + '°', 525, 200) #Prints the snapped to angle value
        elif len(str(newAngle)) == 3:
            text(str(newAngle) + '°', 515, 200) #Prints the snapped to angle value
